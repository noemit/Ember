...
export const GEM_COLORS: GemColor[] = [
  ...
  { name: 'sapphire', base: '#3a7dff', light: '#86b0ff', dark: '#1a4aa0', edge: '#10306b' },
  ...
  { name: 'onyx', base: '#4a515c', light: '#6b7280', dark: '#1c1f24', edge: '#0e1013' },
  ...
  { name: 'garnet', base: '#c22745', light: '#d65b6f', dark: '#6b0f20', edge: '#450a14' },
];
